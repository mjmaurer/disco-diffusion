...
frames_skip_steps_schedule_3d = [.75] * (turbo_steps * 2 - 2) + [.25] * 2 # list(np.linspace(0.75, 0.25, turbo_steps * 2))
...
steps_schedule = [150]
rotation_3d_x = "0: (0), 24: (0.45*cos(1.2*3.141*t/108))"
rotation_3d_y = "0: (0.4*sin(3.141*t/108))"
