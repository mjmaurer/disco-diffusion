...
flow_vid_input = None # "/notebooks/init_images/_89timdance.mp4" 
...
styled_seconds = 1
ramp_seconds = 5
strength_schedule = list(np.linspace(0, 0.2, 24))

psych_poster_seed = 245114
seed = random.random() * 1000000
flow_blend_schedule = (
    list(np.linspace(0, 0.95, 12))
